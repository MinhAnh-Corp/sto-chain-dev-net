...
const (
	Query_Params_FullMethodName   = "/stochain.tokenfactory.Query/Params"
	Query_Denom_FullMethodName    = "/stochain.tokenfactory.Query/Denom"
	Query_DenomAll_FullMethodName = "/stochain.tokenfactory.Query/DenomAll"
)
