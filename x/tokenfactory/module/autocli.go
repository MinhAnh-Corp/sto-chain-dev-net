...
import (
	...
	modulev1 "stocchain/api/stochain/tokenfactory"
)
		...
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			RpcCommandOptions: []*autocliv1.RpcCommandOptions{
				...
				},
				{
					...
					Use:       "create-denom [owner] [denom] [description] [ticker] [precision] [url] [maxSupply] [canChangeMaxSupply]",
					...
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{
						...
						{ProtoField: "url"},
						{ProtoField: "maxSupply"},
						{ProtoField: "canChangeMaxSupply"},
					},
				},
				{
					RpcMethod: "UpdateDenom",
					Use:       "update-denom [owner] [denom] [description] [url] [maxSupply] [canChangeMaxSupply]",
					Short:     "Update Denom",
					PositionalArgs: []*autocliv1.PositionalArgDescriptor{
						{ProtoField: "owner"},
						{ProtoField: "denom"},
