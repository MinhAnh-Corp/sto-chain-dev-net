...
import (
	...
	tokenfactorymodulev1 "stocchain/api/stochain/tokenfactory/module"
	_ "stocchain/x/tokenfactory/module" // import for side-effects
	tokenfactorymoduletypes "stocchain/x/tokenfactory/types"
